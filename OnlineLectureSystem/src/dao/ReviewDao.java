...
public class ReviewDao {
	...
	public void violentReviewDel() {// ㅊㄱ0206
		String sql = " UPDATE REVIEW SET DELYN = 'Y' WHERE DELYN IS NULL ";
		sql += " AND EXISTS (SELECT 1 FROM SWEAR_WORDS WHERE CONTENT LIKE '%' || WORD_NAME || '%') ";
		jdbc.update(sql);
	}
