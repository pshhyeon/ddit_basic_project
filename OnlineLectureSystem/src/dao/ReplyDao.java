...
public class ReplyDao {
	...
	public void replyInsert(List<Object> param) { // 0205 추가
		String sql = " INSERT INTO REPLY (REPLY_CONTENT , REVIEW_NO , USER_NO)\r\n" + "VALUES(?,?,?) ";
		jdbc.update(sql, param);

	}

	public List<Map<String, Object>> replyList(List<Object> param) { // 0205 추가
	...
	public void replyUpdate(List<Object> param) { // 0205추가
